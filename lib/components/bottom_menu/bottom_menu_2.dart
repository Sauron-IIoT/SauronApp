...
class _ExhibitionBottomSheetState extends State<ExhibitionBottomSheet>
    ...
    return Positioned(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.horizontal(
          left: Radius.circular(iconLeftBorderRadius ?? 0),
          right: Radius.circular(iconRightBorderRadius ?? 0),
        ),
        child: Image.asset(
  ...
  Widget _buildFullItem(Event event) {
    ...
    return ExpandedEventItem(
      ...
      leftMargin: iconLeftMargin(index) ?? 10,
      height: iconSize ?? 10,
      isVisible: _controller.status == AnimationStatus.completed,
      borderRadius: itemBorderRadius ?? 10,
      title: event.title,
      date: event.date,
    );
  }
...
final List<Event> events = [
  Event('warning.png', 'Shenzhen GLOBAL DESIGN AWARD 2018', '4.20-30'),
  Event('warning.png', 'Shenzhen GLOBAL DESIGN AWARD 2018', '4.20-30'),
  Event('warning.png', 'Dawan District Guangdong Hong Kong', '4.28-31'),
  Event('warning.png', 'Shenzhen GLOBAL DESIGN AWARD 2018', '4.20-30'),
  Event('warning.png', 'Shenzhen GLOBAL DESIGN AWARD 2018', '4.20-30'),
  Event('warning.png', 'Dawan District Guangdong Hong Kong', '4.28-31'),
  Event('warning.png', 'Shenzhen GLOBAL DESIGN AWARD 2018', '4.20-30'),
